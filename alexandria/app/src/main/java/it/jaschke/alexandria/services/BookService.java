...
public class BookService extends IntentService {
    ...
    private void fetchBook(String ean) {
        ...
        try {
            ...
            if (inputStream == null) {
                Utility.setSearchStatus(getBaseContext(), SEARCH_STATUS_UNKNOWN);
            } else {
                ...
                if (buffer.length() == 0) {
                    Utility.setSearchStatus(getBaseContext(), SEARCH_STATUS_SERVER_DOWN);
                } else {
                    String bookJsonString = buffer.toString();
                    ...
                    if (bookJson.has(ITEMS)) {
                        ...
                        Utility.setSearchStatus(getBaseContext(), SEARCH_STATUS_OK);
                        ...
                        Utility.setSearchStatus(getBaseContext(), SEARCH_STATUS_OK_EMPTY);
                    }
                }
            }
            ...
            e.printStackTrace();
            Utility.setSearchStatus(getBaseContext(), SEARCH_STATUS_SERVER_INVALID);
        } finally {
